...
tuple<double, double>forces(void)
{ double Px,Py;
...
return make_tuple(Ca,Re);//Imprimir los numeros del coeficiente de arrastre y reynolds
...
double Ca,Re;
double x=0.02;
ofstream salida("CavsRe.dat");
for(double tau=0.508;tau<7.2;tau+=x){
//Start
if(tau==2.5){
  x=0.1;
}
